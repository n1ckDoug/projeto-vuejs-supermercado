...
const dataDoEvento = new Date("Sep 29, 2024 18:37:00");
...
<template>
  ...
  <div class="container">
    <header id="header"
      ...
      <div class="col-md-3 mb-2 mb-md-0">
        <a href="#" class="d-flex link-body-emphasis text-decoration-none fw-bold">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        <li><a href="#home" class="nav-link px-2 fw-bold active">Home</a></li>
        <li><a href="#sobre" class="nav-link px-2 fw-bold">Sobre</a></li>
        <li><a href="#servicos" class="nav-link px-2 fw-bold">Serciços</a></li>
        <li><a href="#shop" class="nav-link px-2 fw-bold">Shop</a></li>
        <li><a href="#contato" class="nav-link px-2 fw-bold">Contato</a></li>
      </ul>
      ...
      <div class="col-md-3 text-end">
        <ul style="list-style: none;" class="d-flex align-items-center">
          ...
          <li><a href="#" class="btn btn-success">Cadastre-se</a></li>
        </ul>
      </div>
    </header>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7">
          ...
          <p class="fs-5">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque, iste. Dolorum amet
            fugit, maiores iure mollitia dignissimos ipsum ad perspiciatis.</p>
          <a href="#" class="btn btn-warning mb-5 text-center">Compre agora <i class="bi bi-arrow-right"></i></a>
        </div>
        <div class="col-lg-5">
          <img class="d-block w-100" src="./images/supermercado.png" alt="">
        </div>
      </div>
      <div class="row mt-5">
        <div class="col-lg-4">
          <div class="card mb-3">
            <div class="card-body">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <p><strong class="fw-bold">Frete grátis</strong> <br> Com qualquer compra acima de R$100,00</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card mb-3">
            <div class="card-body">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <p><strong class="fw-bold">Pagamento seguro</strong> <br> Ao utilizar nossos serviços</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card mb-3">
            <div class="card-body">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <p><strong class="fw-bold">Qualidade garantida</strong> <br> Nossos produtos são da melhor
                    qualidade</p>
                </div>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        <div class="d-lg-flex align-items-center">
          <div class="col-lg-6">
            <img class="d-block w-100" src="./images/frutas.png" alt="">
          </div>
          <div style="color: white;" class="col-lg-6">
            <h2>Ofertas Semanais</h2>
            <h1 class="fw-bold">Confira a oferta do dia</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique ut, dolor maxime at ad doloremque
  ...
  <section id="produtos" class="mt-5 mb-5 pt-5 pb-5">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4" v-for="mercadoria in produtos.mercadoria">
          <div :id="mercadoria.productId" class="card mt-5" style="width: 100%;">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between">
                ...
                <p><strong>{{ mercadoria.preco }}</strong></p>
              </div>
              <div class="d-flex align-items-center justify-content-between">
                <p><span style="color: hsl(42.9deg 100% 59.41%);"><i class="bi bi-star-fill"></i> <i
                      ...
                      class="bi bi-star-fill"></i></span> ( {{ mercadoria.avaliacoes }} )</p>
                ...
                <div class="col-lg-4">
                  <div class="card-comentarios w-100 me-5 mb-5 p-5">
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <img src="https://via.placeholder.com/200x200" class="d-block w-100 border" alt="">
                      </div>
                      <p class="mt-3"><span class="fw-bold text-warning">"</span>Lorem ipsum dolor sit amet consectetur,
                        adipisicing elit. Assumenda eius iure labore rerum eveniet eaque a velit reprehenderit, possimus
                        cupiditate dolorum nobis cum hic perferendis pariatur repellat itaque delectus iste, quis autem.
                        Ea maxime veniam delectus aut? Voluptatum, cupiditate? Eius at dolore dolorum nostrum sequi
                        temporibus ipsam in rerum, aperiam, atque possimus consequuntur doloribus hic harum aliquam?
                        Earum dolor pariatur quisquam, autem dolorem asperiores dolores amet doloremque ducimus quod.
                        Amet veritatis quasi fugiat nesciunt cupiditate omnis ea culpa, optio et totam consequatur
                        veniam itaque consectetur? Quisquam dolorem esse libero? Cumque quisquam sit ullam temporibus
                        incidunt nobis magni illo doloremque quis?<span class="fw-bold text-warning">"</span> </p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="card-comentarios w-100 me-5 mb-5 p-5">
                    <div class="row">
                      ...
                      <p class="mt-3"><span class="fw-bold text-warning">"</span> Lorem ipsum dolor sit amet
                        consectetur
                        adipisicing elit. Quo autem ipsam quas. Ipsam quaerat expedita, enim ea itaque saepe
                        laboriosam
                        voluptates soluta optio eos voluptate<span class="fw-bold text-warning">"</span> </p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="carousel-item active">
              <div class="card-comentarios w-100 me-5 mb-5 p-5">
                <div class="row">
                  ...
                  <p class="mt-3"><span class="fw-bold text-warning">"</span>Lorem ipsum dolor sit amet, consectetur
                    adipisicing elit. Tenetur magni vel saepe recusandae ipsam, exercitationem labore quas laboriosam
                    quos! Architecto soluta nihil delectus inventore distinctio repellendus cupiditate! Iure non
                    repellat quae, voluptas nobis eos exercitationem recusandae corporis odit atque. Dolores asperiores
                    officia ratione nulla nam voluptates vel laboriosam delectus dolor maxime eaque cumque quo, nesciunt
                    doloribus natus suscipit aspernatur amet, quisquam quam. Voluptates eveniet necessitatibus earum
                    accusamus corporis reprehenderit illo quam sit, vel, nisi quas ut quia impedit temporibus rerum,
                    molestiae pariatur soluta est laudantium nam. Quidem quis velit laborum, eius porro accusantium
                    eveniet labore quia nesciunt eos perferendis dolorem.<span class="fw-bold text-warning">"</span>
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-lg-3 mb-3">
          <a href="#" class="d-flex text-light text-decoration-none fw-bold">
            <i class="fs-1 text-success me-2 bi bi-cart4"></i>
            <p class="fs-5 text-uppercase text-light"><span class="text-success">Nome do</span> <br> Mercado</p>
          </a>
          <p class="text-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem adipisci assumenda
            exercitationem</p>
        ...
        <div class="col-lg-3 mb-3">
          ...
          <p class="text-light"><i class="bi bi-geo-alt"></i> Endereço <br> Rua qualquer, 123 - São Paulo - SP</p>
        </div>
        <div class="col-lg-3 mb-3">
...
#home .card {
  border-color: rgb(77 175 72);
  border-radius: 20px;
}

#home .card .home-card-icon {
  border-radius: 50%;
  background-color: rgb(77 175 72);
  text-align: center;
  color: white;
}
...
#sobre .img02 {
  background-image: url(./images/leite.png);
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
  width: 100%;
...
#oferta .time-promotion #contador #contador_dia,
#oferta .time-promotion #contador #contador_horas,
#oferta .time-promotion #contador #contador_minutos,
#oferta .time-promotion #contador #contador_segundos {
  text-align: center;
  padding: 20px;
  border-radius: 10px;
  color: #000;
...
/* width */
#comentarios .card-comentarios::-webkit-scrollbar {
  width: 0px;
}
...
footer p {
  color: hsl(119.45deg 45.61% 53.14%);
}
</style>